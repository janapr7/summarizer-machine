    ...
    return (
        <>
            <div className="bg-secondary rounded-md p-2">
                ...
                <p className="font-content text-base my-2 mt-5">Konten utama jurnal yang dimaksud terbagi ke dalam beberapa aspek utama:</p>
                ...
                <p className="font-content text-base my-2 mt-5"><span className="font-semibold">Cara kerja mesin</span> bisa dengan memasukkan langsung isi jurnal dengan meng-copy and paste ke kota teks pada mesin penerjemah atau dengan memilih file pdf dari artikel/jurnal yang akan diringkas.</p>
            </div>
        </>
    )
}